...
#define SEGMENT_INTERVAL0_NS  (1000000ULL)
#define SEGMENT_INTERVAL1_MS  (0.3)
#define SEGMENT_INTERVAL1_NS  (300000ULL)
#define SEGMENT_INTERVAL2_MS  (0.1)
#define SEGMENT_INTERVAL2_NS  (100000ULL)
...
#define DO_SLEEP_SEGMENT(elapsed, total, start, now, stage)                                     \
  while (((elapsed) + SEGMENT_INTERVAL##stage##_NS + SEGMENT_##stage##_JITTER_NS) < (total)) {  \
