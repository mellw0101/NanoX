...
static __inline__ void under_callback_mutex(Callback &&callback) {
...
void init_callback_queue(void) {
  ...
  callback_queue->head = nullptr;
  callback_queue->tail = nullptr;
  pthread_mutex_init(&callback_queue->mutex, nullptr);
}
