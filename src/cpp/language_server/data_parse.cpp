...
namespace Parse
{
    inline namespace utils
    {
        ...
        string
        parse_var_type(linestruct *from, const char **data_ptr, const char **end_ptr)
        {
        ...
        var_t
        parse_typedef(linestruct *from, const char *type)
        {
            Uint        idx;
    ...
    void
    variable(linestruct *line, vector<var_t> &var_vector)
    {
