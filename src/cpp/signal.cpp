...
void
send_SIGUSR1_to_main_thread(void)
{
...
void
handle_main_thread_signal(int sig, siginfo_t *si, void *context)
{
...
void
send_signal_to_main_thread(callback_functionptr_t func, void *arg)
{
...
void
setup_signal_handler_on_sub_thread(void (*handler)(int))
{
...
void
block_pthread_sig(int sig, bool block)
{
    sigset_t mask;
