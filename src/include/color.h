...
#define xterm_color_index(r, g, b)                                      \
    short(16 + (36 * xterm_byte_scale(r)) + (6 * xterm_byte_scale(g)) + \
          xterm_byte_scale(b))

#define xterm_std_color_index(r, g, b) \
    xterm_color_index(((double)r / 6), ((double)g / 6), ((double)b / 6)) - 16

#define grayscale_xterm_byte(r, g, b) \
    round_short(((0.299 * (r) + 0.587 * (g) + 0.114 * (b)) / 255.0) * 5)

#define grayscale_xterm_color_index(r, g, b)   \
    (16 + 36 * grayscale_xterm_byte(r, g, b) + \
     6 * grayscale_xterm_byte(r, g, b) + grayscale_xterm_byte(r, g, b))

#define xterm_grayscale_color_index(r, g, b) \
    grayscale_xterm_color_index(r, g, b)
