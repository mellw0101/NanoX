...
// } undo_modifier_type;
  ...
  typedef enum {
    ...
    GUIELEMENT_LEFT_MOUSE_CLICK,
    GUIELEMENT_LEFT_MOUSE_UNCLICK,
  ...
  # define GUIELEMENT_LEFT_MOUSE_CLICK    GUIELEMENT_LEFT_MOUSE_CLICK
  # define GUIELEMENT_LEFT_MOUSE_UNCLICK  GUIELEMENT_LEFT_MOUSE_UNCLICK
