...
bool  using_utf8(void) _NO_EXCEPT __warn_unused;
bool  is_alpha_char(const char *c) _NO_EXCEPT __warn_unused __nonnull((1));
bool  is_blank_char(const char *c) _NO_EXCEPT __warn_unused __nonnull((1));
bool  is_cntrl_char(const char *c) _NO_EXCEPT __warn_unused __nonnull((1));
bool  is_word_char(const char *c, bool allow_punct) _NO_EXCEPT __warn_unused __nonnull((1));
char  control_mbrep(const char *c, bool isdata) _NO_EXCEPT __warn_unused __nonnull((1));
int   mbtowide(wchar_t *wc, const char *c) _NO_EXCEPT __warn_unused __nonnull((1));
bool  is_doublewidth(const char *ch) _NO_EXCEPT __warn_unused __nonnull((1));
bool  is_zerowidth(const char *ch) _NO_EXCEPT __warn_unused __nonnull((1));
int   char_length(const char *const &pointer) _NO_EXCEPT __warn_unused;
Ulong mbstrlen(const char *pointer) _NO_EXCEPT;
int   collect_char(const char *string, char *thechar) _NO_EXCEPT;
int   advance_over(const char *string, Ulong &column) _NO_EXCEPT;
Ulong step_left(const char *buf, Ulong pos) _NO_EXCEPT;
Ulong step_right(const char *buf, Ulong pos) _NO_EXCEPT;
int   mbstrcasecmp(const char *s1, const char *s2) _NO_EXCEPT;
int   mbstrncasecmp(const char *s1, const char *s2, Ulong n) _NO_EXCEPT;
char *mbstrcasestr(const char *haystack, const char *needle) _NO_EXCEPT;
char *revstrstr(const char *haystack, const char *needle, const char *pointer) _NO_EXCEPT;
char *mbrevstrcasestr(const char *haystack, const char *needle, const char *pointer) _NO_EXCEPT;
char *mbstrchr(const char *string, const char *chr) _NO_EXCEPT;
char *mbstrpbrk(const char *string, const char *accept) _NO_EXCEPT;
char *mbrevstrpbrk(const char *head, const char *accept, const char *pointer) _NO_EXCEPT;
bool  has_blank_char(const char *string) _NO_EXCEPT;
bool  white_string(const char *string) _NO_EXCEPT;
...
const char *tail(const char *path) __returns_nonnull __nonnull((1));
const char *ext(const char *path);
char       *concatenate(const char *path, const char *name);
char       *concatenate_path(const char *prefix, const char *suffix) _NO_EXCEPT __nonnull((1, 2));
const char *concat_path(const char *s1, const char *s2) _NO_EXCEPT __nonnull((1, 2));
int         digits(long n) _NO_EXCEPT;
bool        parse_num(const char *string, long *result) _NO_EXCEPT __nonnull((1, 2));
bool        parse_line_column(const char *str, long *line, long *column) _NO_EXCEPT __nonnull((1, 2, 3));
void        recode_NUL_to_LF(char *string, Ulong length) _NO_EXCEPT __nonnull((1));
Ulong       recode_LF_to_NUL(char *string) _NO_EXCEPT __nonnull((1));
...
bool        is_separate_word(Ulong position, Ulong length, const char *buf) _NO_EXCEPT;
...
char       *memmove_copy_of(const char *string) _NO_EXCEPT __returns_nonnull __nonnull((1));
char       *free_and_assign(char *dest, char *src) _NO_EXCEPT;
Ulong       get_page_start(Ulong column) _NO_EXCEPT;
Ulong       xplustabs(void) _NO_EXCEPT;
Ulong       actual_x(const char *text, Ulong column) _NO_EXCEPT __nonnull((1));
Ulong       wideness(const char *text, Ulong maxlen) _NO_EXCEPT __nonnull((1));
Ulong       breadth(const char *text) _NO_EXCEPT __nonnull((1));
...
Ulong       number_of_characters_in(const linestruct *begin, const linestruct *end) _NO_EXCEPT __nonnull((1, 2));
const char *strstrwrapper(const char *haystack, const char *needle, const char *start);
char       *alloced_pwd(void);
char       *alloc_str_free_substrs(char *str_1, char *str_2) _NO_EXCEPT __nonnull((1, 2));
