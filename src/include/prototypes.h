...
bool  using_utf8(void) _NOTHROW __warn_unused;
bool  is_enclose_char(const char ch) _NOTHROW __warn_unused;
bool  is_alpha_char(const char *c) _NOTHROW __warn_unused __nonnull((1));
bool  is_alnum_char(const char *const c) _NOTHROW __warn_unused __nonnull((1));
bool  is_blank_char(const char *c) _NOTHROW __warn_unused __nonnull((1));
bool  is_prev_blank_char(const char *pointer, Ulong index) _NOTHROW __warn_unused __nonnull((1));
bool  is_prev_cursor_blank_char(void) _NOTHROW __warn_unused;
bool  is_cursor_blank_char(void) _NOTHROW __warn_unused;
bool  is_cntrl_char(const char *c) _NOTHROW __warn_unused __nonnull((1));
bool  is_word_char(const char *c, bool allow_punct) _NOTHROW __warn_unused __nonnull((1));
bool  is_prev_word_char(const char *pointer, Ulong index, bool allow_punct = FALSE) _NOTHROW __warn_unused __nonnull((1));
bool  is_prev_cursor_word_char(bool allow_punct = FALSE) _NOTHROW __warn_unused;
bool  is_prev_char(const char *pointer, Ulong index, const char ch) _NOTHROW __warn_unused __nonnull((1));
bool  is_prev_cursor_char(const char ch) _NOTHROW __warn_unused;
bool  is_prev_char_one_of(const char *pointer, Ulong index, const char *chars) _NOTHROW __warn_unused __nonnull((1, 3));
bool  is_prev_cursor_char_one_of(const char *chars) _NOTHROW __warn_unused __nonnull((1));
bool  is_cursor_char(const char ch) _NOTHROW __warn_unused;
bool  is_char_one_of(const char *pointer, Ulong index, const char *chars) _NOTHROW __warn_unused __nonnull((1, 3));
bool  is_cursor_char_one_of(const char *chars) _NOTHROW __warn_unused __nonnull((1));
bool  is_between_chars(const char *pointer, Ulong index, const char pre_ch, const char post_ch) _NOTHROW __warn_unused __nonnull((1));
bool  is_cursor_between_chars(const char pre_ch, const char post_ch) _NOTHROW __warn_unused;
char  control_mbrep(const char *c, bool isdata) _NOTHROW __warn_unused __nonnull((1));
int   mbtowide(wchar_t *wc, const char *c) _NOTHROW __warn_unused __nonnull((1));
bool  is_doublewidth(const char *ch) _NOTHROW __warn_unused __nonnull((1));
bool  is_zerowidth(const char *ch) _NOTHROW __warn_unused __nonnull((1));
int   char_length(const char *const &pointer) _NOTHROW __warn_unused;
...
linestruct *copy_node(const linestruct *src) _NOTHROW __warn_unused __nonnull((1));
linestruct *copy_buffer(const linestruct *src) _NOTHROW __warn_unused;
...
char      **get_env_paths(Ulong *npaths) _NOTHROW __warn_unused __nonnull((1));
...
char       *concatenate(const char *path, const char *name) _NOTHROW __warn_unused __returns_nonnull __nonnull((1, 2));
char       *concatenate_path(const char *prefix, const char *suffix) _NOTHROW __warn_unused __returns_nonnull __nonnull((1, 2));
const char *concat_path(const char *s1, const char *s2) _NOTHROW __nonnull((1, 2));
int         digits(long n) _NOTHROW __warn_unused;
bool        parse_num(const char *string, long *result) _NOTHROW __warn_unused __nonnull((1, 2));
...
char       *measured_memmove_copy(const char *string, const Ulong count) _NOTHROW __returns_nonnull __nonnull((1));
char       *memmove_copy_of(const char *string) _NOTHROW __returns_nonnull __nonnull((1));
char       *free_and_assign(char *dest, char *src) _NOTHROW;
Ulong       get_page_start(Ulong column) _NOTHROW;
Ulong       xplustabs(void) _NOTHROW __warn_unused;
Ulong       actual_x(const char *text, Ulong column) _NOTHROW __warn_unused __nonnull((1));
Ulong       wideness(const char *text, Ulong maxlen) _NOTHROW __warn_unused __nonnull((1));
Ulong       breadth(const char *text) _NOTHROW __warn_unused __nonnull((1));
...
Ulong extra_chunks_in(linestruct *line) _NOTHROW __warn_unused __nonnull((1));
...
bool         word_more_than_one_white_away(bool forward, Ulong *nsteps) _NOTHROW;
...
Ulong        get_prev_word_start_index(const char *line, Ulong cursor_x, bool allow_underscore = FALSE) _NOTHROW __warn_unused __nonnull((1));
Ulong        get_prev_cursor_word_start_index(bool allow_underscore = FALSE) _NOTHROW __warn_unused;
char        *get_prev_word(const char *cursorline, const Ulong cursor_x, Ulong *wordlen) _NOTHROW __warn_unused __nonnull((1, 3));
char        *get_prev_cursor_word(Ulong *wordlen) _NOTHROW __warn_unused __nonnull((1));
Ulong        get_current_word_end_index(const char *line, Ulong from_index, bool allow_underscore = FALSE) _NOTHROW __warn_unused __nonnull((1));
...
bool  line_in_marked_region(linestruct *line) _NOTHROW __warn_unused __nonnull((1));
...
char **split_string(const char *string, const char delim, Ulong *n) _NOTHROW __warn_unused __nonnull((1, 3));
